          ...
          >
            <div className="qualification__data">
              <div>
                ...
                <span className="qualification__subtitle">Unknown Inc</span>
                <div className="qualification__calendar">
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">Accountant</h3>
                <span className="qualification__subtitle">QES-Bangalore</span>
                <div className="qualification__calendar">
            ...
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">College Student</h3>
                <span className="qualification__subtitle">Bangalore-India</span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> 2020-Present
                </div>
              </div>
